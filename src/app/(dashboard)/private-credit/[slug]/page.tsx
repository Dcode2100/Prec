...
import {
  getAllCategoriesOptionList,
  getPcAssetById,
  updatePcAsset,
} from '@/lib/api/creditApi'
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
const CreditDetailsForm = () => {
  ...
  const fetchAssets = async () => {
    const data = await getPcAssetById(slug as string)
    return data
  }

  const { data: selectedAsset } = useQuery({
    queryKey: ['pc-asset-' + slug],
    queryFn: () => fetchAssets(),
  })
  ...
  return (
    <div className="w-full px-10  overflow-auto ">
      ...
      <div className="h-full space-y-2 mb-[100px]">
        <Formik
        ...
        >
          {({ errors, touched, values, setFieldValue }) => (
            <Form className="space-y-2  w-full" id="update-asset-form">
              <div className="mb-4">
