...
const EquityDetailsForm = ({ setIsSheetOpen, refetch }: AssetFormProps) => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    try {
      const response = await updateAnAsset(selectedAssetToken, values)
  ...
  return (
    <SheetContent className="min-w-[500px]">
      ...
      {error ? (
        ...
        <div className="space-y-2 h-[85vh] overflow-auto p-2">
          <Formik
              ...
              <Form className="space-y-2 ">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-[8vh] p-4 bg-background/80 backdrop-blur-sm border-t flex items-center justify-start shadow-lg">
                  ...
                  <Button
                    ...
                    className="ml-4"
                    onClick={() =>
                      router.push(`/privateequity/${selectedAssetToken}`)
                    }
                  >
                    Update more details
                  </Button>
